...
public class Main 
{
    ...
    public static void main (String args[]) 
    {
        ...
        java.util.Random r = new java.util.Random( 2451 );
        double[][] customers = new double[40][2];
        for( int i = 0; i < 40; i++ )
            for( int j = 0; j < 2; j++ )
        ...
        // Start solving
        tabuSearch.setIterationsToGo( 10000000 );
        ...
        for( int i = 0; i < tour.length; i++ )
            System.out.println( 
                    (customers[tour[i]][0] + "\t" + customers[tour[i]][1]).replace(".", ","));
    }   // end main
